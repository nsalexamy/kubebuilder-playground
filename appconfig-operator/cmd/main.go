...
import (
	...
	"github.com/nsalexamy/kubebuilder-playground/appconfig-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(nsalexamycomv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "168e07c2.nsalexamy.com",
